                        ...
                        <div className="space-y-6 lg:space-y-10">
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        No matter where your legs take you, your
                                        notes will be right there with you.
                                    </p>
                                </div>
                            </div>
                            {/* End Icon Block */}
                        ...
                        <div className="space-y-6 lg:space-y-10">
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        Utilize your pen to capute thoughts and
                                        ideas. You are no longer bound to just
                                        keyboard and mouse.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="ms-5 sm:ms-8">
                                    ...
                                    <p className="mt-1 text-muted-foreground">
                                        Your data is stored right there on your
                                        device. Backed by SQLite, and performant
                                        database solution for the web.
                                    </p>
                                </div>
                            </div>
                            {/* End Icon Block */}
