                ...
                <div className="grid">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-light text-gray-400">
                      Responsible for sync, DO NOT SHARE, DO NOT LOSE.
                    </span>
                  </div>
                </div>
                <CopySecret />
            ...
            <CardContent className="grid gap-x-20 gap-y-5">
              ...
              <div className="flex flex-row justify-between">
                <div className="grid">
                  <h1>Delete Data</h1>
                  <span className="text-sm font-light text-gray-400">
                    Delete&apos;s all the data in the local database. A clean
                    start.
                  </span>
                </div>
                <Button variant="destructive" className="w-32" onClick={nuke}>
                  Delete Data
                </Button>
              </div>
            </CardContent>
